...
<head>
    ...
    <meta charset="utf-8">
    <title>J-Bot Japanese Language Practice Chatbot</title>
	
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Practice Japanese conversation using AI.">
	
    <!-- Image -->
    <link rel="shortcut icon" type="image/png" href="assets/j-icon.png">
...
<body>
    <p class="w3-small w3-padding-left w3-text-white hide-on-phone space-letters"><a href="https://github.com/vbookshelf/J-Bot-Japanese-Language-Practice-Chatbot" target="_blank">GitHub</a> - <a href="https://t-bot.woza.work/" target="_blank">Practice Thai</a> - <a href="https://e-bot.woza.work/" target="_blank">Practice English</a></p>
    <div class="container w3-animate-opacity">
        <div id="main-image" class="w3-center w3-round w3-padding w3-text-blue">
			...
			<h2 class="space-letters"><b>J-Bot Japanese Practice Chatbot</b></h2>
			
            <h4 class="space-letters"><b>Practice Japanese conversation using AI</b></h4>
		
        </div>
        <main id="chat" class="texts">
            <div class="message-container">
                <span id="first-chat-block" class="set-color1"><b>&#x2022 J-Bot</b></span>
                
                <ul class="lighter-black instruction-text">
					<li>Hi. Welcome to J-Bot.</li>
					...
					<li>Chat ideas:<br>
						...
						- Who was Miyamoto Musashi?<br>
						- Is there life on other planets?
					</li>
					<li>Please be kind. J-Bot will make mistakes.</li>	
		...
		<button class="" id="start-voicechat-btn" onclick="start_recog(submit_text_to_php, lang_code)">Start Voicechat</button>
            ...
            <form id="myForm" action="main.php" method="post">
                <input id="user-input" type="text" name="my_message" placeholder="Type or talk in Japanese" autofocus>
